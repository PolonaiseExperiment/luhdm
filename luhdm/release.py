...
``release/luhdm_datarelease_v10_A_f1_atm.h5`` (f_DM = 1, attenuated) and
``release/luhdm_datarelease_v10_B_f0p1_noatm.h5`` (f_DM = 0.1, bare halo). Pass
...
DEFAULT_PATH = Path(__file__).resolve().parents[1] / "release" / "luhdm_datarelease_v10_A_f1_atm.h5"
