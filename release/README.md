...
| `exclusion_massless_mode1.png` | 64 kB | The figure produced by [§6](#6-worked-example-the-published-limit), for reference. Regenerated by section 7 of `notebooks/05_using_the_data_release.ipynb`. |
...
to `alpha_n = 2.6 × 10⁻⁹` at 95% CL at a mass of 8.1 × 10⁶ GeV, over a mass
...
* the **left** end, 9.02 × 10⁵ GeV, is the first mass grid point above the
...
* the **right** end is set by `m_cut` and by nothing in the surfaces: 19 further
...
* the band is **open at the top over part of the window**. With the cap removed,
  ...
  everywhere: 8 of the 37 in-window masses run to `alpha_n = 1`, the top of the
